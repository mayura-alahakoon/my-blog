...
/* harmony import */ var _mdx_js_react__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(7834);
/* harmony import */ var github_slugger__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(8904);
/* harmony import */ var github_slugger__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(github_slugger__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var prism_react_renderer__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(7096);
/* harmony import */ var prism_react_renderer__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(prism_react_renderer__WEBPACK_IMPORTED_MODULE_9__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_mdx_js_react__WEBPACK_IMPORTED_MODULE_7__]);
_mdx_js_react__WEBPACK_IMPORTED_MODULE_7__ = (__webpack_async_dependencies__.then ? await __webpack_async_dependencies__ : __webpack_async_dependencies__)[0];
...
function ThemeSwitch() {
  const { theme, setTheme, resolvedTheme } = (0,next_themes__WEBPACK_IMPORTED_MODULE_6__.useTheme)();
  ...
  }, mounted && (theme === "dark" || resolvedTheme === "dark") ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", {
    fill: "none",
    viewBox: "0 0 24 24",
    width: "24",
    height: "24",
...
function Meta({ author, date, tag, back, config }) {
  ...
  const dateNode = date ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("time", null, new Date(date).toDateString()) : null;
  ...
  })), back ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(next_link__WEBPACK_IMPORTED_MODULE_3__["default"], {
    href: back
  }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    className: "meta-back"
  }, "Back")) : null, config.darkMode && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ThemeSwitch, null));
}

// src/nav.js


function Nav({ navPages, config }) {
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "nav-line"
  }, navPages.map((page) => {
    if (page.active) {
  ...
  }), config.darkMode && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ThemeSwitch, null));
}
...
var SluggerContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)();
var HeaderLink = (_a) => {
  var _b = _a, { tag: Tag, children } = _b, props = __objRest(_b, ["tag", "children"]);
  const slugger = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(SluggerContext);
  const slug = slugger.slug(react_dom_server__WEBPACK_IMPORTED_MODULE_1___default().renderToStaticMarkup(children) || "");
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Tag, __spreadValues({}, props), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
...
var H2 = (_a) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(HeaderLink, __spreadValues({
    tag: "h2"
  }, props), children);
};
var H3 = (_a) => {
...
var A = (_a) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(next_link__WEBPACK_IMPORTED_MODULE_3__["default"], {
    href: props.href
  }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", __spreadValues({}, props), children));
};
var Code = (_a) => {
  var _b = _a, { children, className, highlight } = _b, props = __objRest(_b, ["children", "className", "highlight"]);
  const highlightedRanges = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
  ...
  if (!className)
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("code", __spreadValues({}, props), children);
  const language = className.replace(/language-/, "");
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement((prism_react_renderer__WEBPACK_IMPORTED_MODULE_9___default()), __spreadProps(__spreadValues({}, prism_react_renderer__WEBPACK_IMPORTED_MODULE_9__.defaultProps), {
    code: children.trim(),
    language,
    theme: THEME
  }), ({ className: className2, style, tokens, getLineProps, getTokenProps }) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("code", {
    className: className2,
    style: __spreadValues({}, style)
  }, tokens.map((line, i) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", __spreadProps(__spreadValues({
    key: i
  ...
  }), line.map((token, key) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", __spreadValues({
    key
...
var mdx_theme_default = ({ children }) => {
  const slugger = new (github_slugger__WEBPACK_IMPORTED_MODULE_8___default())();
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(SluggerContext.Provider, {
    value: slugger
  }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mdx_js_react__WEBPACK_IMPORTED_MODULE_7__.MDXProvider, {
    components
  }, children));
};
...
function getTitle(content) {
  ...
  const nodes = react__WEBPACK_IMPORTED_MODULE_0___default().Children.toArray(children);
...
var sort_date_default = (a, b) => {
  if (!a.frontMatter || !a.frontMatter.date)
    return -1;
  if (!b.frontMatter || !b.frontMatter.date)
    return -1;
  return new Date(a.frontMatter.date) > new Date(b.frontMatter.date) ? -1 : 1;
};

// src/index.js
var ReactCusdis = (0,next_dynamic__WEBPACK_IMPORTED_MODULE_5__["default"])(() => Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 8273, 23)).then((mod) => mod.ReactCusdis), { ssr: false });
var Layout = ({
  config,
  meta,
  navPages,
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement((next_head__WEBPACK_IMPORTED_MODULE_2___default()), null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("title", null, pageTitle, config.titleSuffix), config.head ? config.head({ title, meta }) : null), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("article", {
    className: "container prose prose-sm md:prose dark:prose-dark"
  }, titleNode || /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, pageTitle), type === "post" ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Meta, __spreadProps(__spreadValues({}, meta), {
    back,
    config
  })) : /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Nav, {
    navPages,
    config
  }), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(mdx_theme_default, null, contentNodes, type === "post" ? config.postFooter : null, type === "post" ? comments : null), postList, config.footer));
};
var src_default = (opts, _config) => {
  const router = (0,next_router__WEBPACK_IMPORTED_MODULE_4__.useRouter)();
  const { theme, resolvedTheme } = (0,next_themes__WEBPACK_IMPORTED_MODULE_6__.useTheme)();
  const config = Object.assign({
    readMore: "Read More \u2192",
    footer: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("small", {
  ...
  if (type === "posts" || type === "tag" || type === "page") {
    ...
    traverse(opts.pageMap, (page) => {
      if (page.frontMatter && ["page", "posts"].includes(page.frontMatter.type)) {
        if (page.route === route) {
          navPages.push(__spreadProps(__spreadValues({}, page), { active: true }));
        } else {
          navPages.push(page);
        }
      }
      ...
      if (page.name.startsWith("_"))
        return;
      if (type === "posts" && !page.route.startsWith(route === "/" ? route : route + "/"))
        return;
    ...
    navPages = navPages.sort(sort_date_default);
  }
  let back = null;
  if (type !== "post") {
    back = null;
  ...
  return (props) => {
    ...
    const pageTitle = opts.meta.title || (typeof tagName === "undefined" ? null : titleNode ? react_dom_server__WEBPACK_IMPORTED_MODULE_1___default().renderToStaticMarkup(titleNode.props.children) : null) || "";
    let comments;
    if (config.cusdis) {
      if (!config.cusdis.appId) {
        console.warn("[cusdis]", "`appId` is required");
      } else {
        comments = /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ReactCusdis, {
    ...
    const postList = posts ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", null, posts.map((post) => {
      if (tagName) {
      ...
      const postDate = post.frontMatter ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("time", {
        className: "post-item-date"
      }, new Date(post.frontMatter.date).toDateString()) : null;
      const postDescription = post.frontMatter && post.frontMatter.description ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
        className: "post-item-desc"
      }, post.frontMatter.description, config.readMore ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(next_link__WEBPACK_IMPORTED_MODULE_3__["default"], {
        href: post.route
      }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
      ...
      return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        key: post.route,
        className: "post-item"
      }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(next_link__WEBPACK_IMPORTED_MODULE_3__["default"], {
        href: post.route
      }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
        className: "post-item-title"
      }, postTitle))), postDescription, postDate);
    })) : null;
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(next_themes__WEBPACK_IMPORTED_MODULE_6__.ThemeProvider, {
      attribute: "class",
      defaultTheme: "system",
      enableSystem: true
    }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Layout, __spreadValues(__spreadValues({
      config,
      postList,
      navPages,
      back,
